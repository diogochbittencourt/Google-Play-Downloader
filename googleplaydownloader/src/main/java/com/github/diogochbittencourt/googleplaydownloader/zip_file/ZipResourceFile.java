...
package com.github.diogochbittencourt.googleplaydownloader.zip_file;
...
public class ZipResourceFile {
    ...
    /**
     * getAssetFileDescriptor allows for ZipResourceFile to directly feed Android API's that want an fd, offset, and
     * length such as the MediaPlayer. It also allows for the class to be used in a content provider that can feed video
     * players. The file must be stored (non-compressed) in the Zip file for this to work.
     *
    ...
    /**
     * getInputStream returns an AssetFileDescriptor.AutoCloseInputStream associated with the asset that is contained in
     * the Zip file, or a standard ZipInputStream if necessary to uncompress the file
     *
