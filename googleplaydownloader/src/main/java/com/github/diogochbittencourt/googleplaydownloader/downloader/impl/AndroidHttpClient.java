...
public final class AndroidHttpClient implements HttpClient {
    ...
    /**
     * Returns the date of the given HTTP date string. This method can identify and parse the date formats emitted by
     * common HTTP servers, such as <a href="http://www.ietf.org/rfc/rfc0822.txt">RFC 822</a>, <a
     * href="http://www.ietf.org/rfc/rfc0850.txt">RFC 850</a>, <a href="http://www.ietf.org/rfc/rfc1036.txt">RFC
     * 1036</a>, <a href="http://www.ietf.org/rfc/rfc1123.txt">RFC 1123</a> and <a href="http://www.opengroup.org/onlinepubs/007908799/xsh/asctime.html">ANSI
     * C's asctime()</a>.
     *
     * @return the number of milliseconds since Jan. 1, 1970, midnight GMT.
     * @throws IllegalArgumentException if {@code dateString} is not a date or of an unsupported format.
     */
