...
public class Helpers {
    ...
    /**
     * Showing progress in MB here. It would be nice to choose the unit (KB, MB, GB) based on total file size, but given
     * what we know about the expected ranges of file sizes for APK expansion files, it's probably not necessary.
     */
    ...
    /**
     * Converts download states that are returned by the {@link IDownloaderClient#onDownloadStateChanged} callback into
     * usable strings. This is useful if using the state strings built into the library to display user messages.
     *
