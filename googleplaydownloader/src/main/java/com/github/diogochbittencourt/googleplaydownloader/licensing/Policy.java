...
public interface Policy {
    ...
    /**
     * NOT_LICENSED means that the server returned back a valid license response that indicated that the user
     * definitively is not licensed
     */
    ...
    /**
     * Provide results from contact with the license server. Retry counts are incremented if the current value of
     * response is RETRY. Results will be used for any future policy decisions.
     *
