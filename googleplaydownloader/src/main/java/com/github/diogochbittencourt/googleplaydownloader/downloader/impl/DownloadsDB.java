...
public class DownloadsDB {
    ...
    protected static class DownloadsContentDBHelper extends SQLiteOpenHelper {
        ...
        /**
         * These two arrays must match and have the same order. For every Schema there must be a corresponding table
         * name.
         */
        ...
        /**
         * Goes through all of the tables in sTables and drops each table if it exists. Altered to no longer make use of
         * reflection.
         */
        ...
        /**
         * Goes through all of the tables in sTables and creates a database with the corresponding schema described in
         * sSchemas. Altered to no longer make use of reflection.
         */
